...
import pytest
import numpy as np
from src.time_series.wind import WindForecaster, WindTimeSeriesEvaluator

def test_wind_forecaster():
    forecaster = WindForecaster(horizon=12)
...
def test_wind_evaluation():
    evaluator = WindTimeSeriesEvaluator()
